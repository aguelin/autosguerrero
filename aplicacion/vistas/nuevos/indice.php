...
<div class="crudProducto">
    ...
    <div class="nuevoProducto">
        <a href="/nuevos/DescargarMensajes"><button type="button" class="btn btn-primary">Descargar datos</button></a>
        <a href="/nuevos/nuevo"><button type="button" class="btn btn-primary">Nuevo vehículo</button></a>
    </div>
