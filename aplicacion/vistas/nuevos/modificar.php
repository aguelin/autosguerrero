...
<div id="form_op" class="row g-4">
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloListaDropDown($modelo, "cod_combustible", Combustibles::dameCombustibles(), ["linea" => false, "class" => "form-control"]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloListaDropDown($modelo, "cod_color", Colores::dameColores(), ["linea" => false, "class" => "form-control"]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloListaDropDown($modelo, "num_puertas", [2 => 2, 3 => 3, 4 => 4, 5 => 5], ["linea" => false, "class" => "form-control"]);
...
<div id="form_op" class="row g-3">
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloListaDropDown($modelo, "caja_cambios", ["Manual" => "Manual", "Automático" => "Automático", "Ambos" => "Ambos"], ["linea" => false, "class" => "form-control"]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloNumber($modelo, "potencia", ["class" => "form-control","step"=>"0.01","max" => 2000]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloNumber($modelo, "km", ["class" => "form-control","step"=>"0.01","max" => 300000]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "fecha_fab", ["class" => "form-control"]);
...
<div id="form_op" class="row g-4">
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloNumber($modelo, "unidades", ["class" => "form-control"]);
    ...
    <div class="form-group col-md-3">
        <div class="form-floating">
            ...
            echo CHTML::modeloNumber($modelo, "precio_base", ["class" => "form-control","step"=>"0.01","max" => 300000]);
    ...
    <div class="form-group col-md-3">
        ...
        echo "&nbsp;&nbsp;".CHTML::modeloListaRadioButton($modelo, "iva", [4 => "4%", 10 => "10%", 21 => "21%"], "&nbsp;");
    ...
    <div class="form-group col-md-3">
        ...
        echo "&nbsp;&nbsp;".CHTML::modeloListaRadioButton($modelo, "oferta", [0 => "0%", 10 => "10%", 15 => "15%", 20 => "20%"], "&nbsp;");
...
echo CHTML::campoBotonSubmit("Modificar vehículo",["class"=>"btn btn-primary"]);
