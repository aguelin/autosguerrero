...
<div class="row">
    <div class="form-group col-md-4">
        <div class="form-floating mb-4">
            <?php
            echo CHTML::campoText("nick", $fil["nick"],["class" => "form-control"]);
            echo CHTML::campoLabel("Nick", "nick");
            ?>
        </div>
    </div>
    <div class="form-group col-md-4">
...
<div class="crudProducto">
    ...
    <div class="nuevoProducto">
        <a href="/usuarios/DescargarMensajes"><button type="button" class="btn btn-primary">Descargar datos</button></a>
        <a href="/usuarios/nuevo"><button type="button" class="btn btn-primary">Nuevo usuario</button></a>
    </div>
