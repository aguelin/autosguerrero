...
<div id="form_op" class="row g-3">
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "nick", ["class" => "form-control", "maxlength" => 50, "placeholder" => "Nick","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloPassword($modelo, "contrasenia", ["class" => "form-control", "maxlength" => 30, "placeholder" => "Contraseña","disabled"=>"true"]);
...
<div id="form_op" class="row g-4">
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloPassword($modelo, "confirmar_contrasenia", ["class" => "form-control", "maxlength" => 30, "placeholder" => "Confirmar contraseña","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "direccion", ["class" => "form-control", "maxlength" => 30, "placeholder" => "Dirección","disabled"=>"true"]);
...
<div id="form_op" class="row g-3">
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "poblacion", ["class" => "form-control", "maxlength" => 30, "placeholder" => "Población","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "provincia", ["class" => "form-control", "maxlength" => 30, "placeholder" => "Provincia","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloNumber($modelo, "cp", ["class" => "form-control", "placeholder" => "CP","disabled"=>"true"]);
...
<div id="form_op" class="row g-4">
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "correo", ["class" => "form-control", "maxlength" => 50, "placeholder" => "Correo","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloText($modelo, "fecha_nacimiento", ["class" => "form-control", "placeholder" => "Fecha de nacimiento","disabled"=>"true"]);
    ...
    <div class="form-group col-md-4">
        <div class="form-floating">
            ...
            echo CHTML::modeloListaDropDown($modelo, "role", Usuarios::dameRoles(), ["linea" => false, "class" => "form-control","disabled"=>"true"]);
