...
$this->titulo = "Nuestros Coches";
$this->cssHead = CHTML::cssFichero("/estilos/coches.css");
$this->scriptHead = CHTML::scriptFichero("/javascript/main.js", ["defer", "type" => "module"]);
            ...
            <div id="sidebar-container">
                  ...
                  <div class="filtrado">
                        ...
                        <form action="" method="POST">
                              ...
                              <?php
                                    echo CHTML::campoListaDropDown("marca", "", Nuevos::dameMarcas(), ["linea" => false, "class" => "form-control", "name" => "marca", "id" => "marca"]);
                                    ?>
...
<div id="container" class="py-5">
      ...
      <h1 class="text-center">Nuestros Coches</h1>
