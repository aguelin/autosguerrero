...
<div class="row">
    ...
    <div class="form-group col-md-4">
        <div class="form-floating mb-4">
            <?php
            echo CHTML::modeloListaDropDown($modelo, $fil["categoria"], Categorias::dameCategorias(), ["linea" => false, "name" => "categoria","class" => "form-control"]);
...
<div class="crudProducto">
    ...
    <div class="nuevoProducto">
        <a href="/alquiler/DescargarMensajes"><button type="button" class="btn btn-primary">Descargar datos</button></a>
        <a href="/alquiler/nuevo"><button type="button" class="btn btn-primary">Nuevo alquiler</button></a>
    </div>
